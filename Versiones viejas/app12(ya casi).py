"""
╔══════════════════════════════════════════════════════════════════════╗
║       Playlist Manager v4.3 — Recovery & Universal Auth             ║
║                                                                      ║
...
class PlaylistManagerUI:
            ...
            ft.Row([
                ...
                ft.Column([
                    ft.Text("Playlist Manager", size=16, weight=ft.FontWeight.W_700,
                            ...
                            opacity=1.0),
                    ft.Text("v4.3", size=9, color=TEXT_DIM,
                            font_family="IBM Plex Sans",
    ...
    def _on_state_changed(self) -> None:
        ...
        is_transfer_active = is_transferring or s.transfer_state == TransferState.DONE
        ...
        if s.transfer_total:
            ...
            prog_label.value = (
                f"{porcentaje}%  ·  "
                f"{s.count_confirmed if s.transfer_state == TransferState.DONE else s.count_processed} ok  /  "
        ...
        self._transfer_btn.disabled = (
            net_blocked or is_transferring or not is_ready or not dest_ok
        )
